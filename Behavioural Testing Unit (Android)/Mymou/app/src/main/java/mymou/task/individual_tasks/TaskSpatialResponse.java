...
public class TaskSpatialResponse extends Task {
    ...
    private void assignObjects() {
        ...
        drawable_grey.setShape(GradientDrawable.RECTANGLE);//OVAL->RECTANGLE
        drawable_grey.setColor(ContextCompat.getColor(getContext(), R.color.grey));
        drawable_red = new GradientDrawable();
        drawable_red.setShape(GradientDrawable.RECTANGLE);//OVAL->RECTANGLE
        drawable_red.setColor(ContextCompat.getColor(getContext(), R.color.red));// yellow->red
        ...
        switch (locations) {
            case 2:
                cues[0].setX(175);//575->175
                cues[1].setX(775);//575->775
                cues[0].setY(900);//400->900
                cues[1].setY(900);//1400->900
                break;
            case 4:
